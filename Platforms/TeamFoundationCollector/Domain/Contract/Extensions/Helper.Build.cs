...
namespace Ban3.Platforms.TeamFoundationCollector.Domain.Contract.Extensions
{
    public static partial class Helper
    {
        ...
        public static GetBuildWorkItemsRefsFromCommitsResult GetBuildWorkItemsRefsFromCommits(this ICore _, GetBuildWorkItemsRefsFromCommits request)
        => ServerResource.BuildGetBuildWorkItemsRefsFromCommits.Execute<GetBuildWorkItemsRefsFromCommitsResult>(request).Result;
        ...
        public static GetChangesBetweenBuildsResult GetChangesBetweenBuilds(this ICore _, GetChangesBetweenBuilds request)
        ...
        public static GetWorkItemsBetweenBuildsResult GetWorkItemsBetweenBuilds(this ICore _, GetWorkItemsBetweenBuilds request)
