...
namespace Ban3.Infrastructures.NativeLibs.Structs
{
    ...
    public struct IO_DISCONNECT_INTERRUPT_PARAMETERS
    {
        /// ULONG->unsigned int
        public uint Version;

        public IO_DISCONNECT_INTERRUPT_PARAMETERS_UNION ConnectionContext;
    }

    [StructLayoutAttribute(LayoutKind.Explicit)]
    public struct IO_DISCONNECT_INTERRUPT_PARAMETERS_UNION
    {
        /// ULONG->unsigned int
        [FieldOffset(0)]
