...
//  function:	IMAGE_OPTIONAL_HEADER64.cs
//  reference:	
//  ————————————————————————————————————————————————————————————————————————————
//
...
namespace Ban3.Infrastructures.NativeLibs.Structs
{
    ...
    {
        [FieldOffset(0)] public IMAGE_FILE_STATE Magic;
        ...
        [FieldOffset(68)] public IMAGE_SUBSYSTEM Subsystem;

        [FieldOffset(70)] public DLL_CHARACTERISTICS DllCharacteristics;
