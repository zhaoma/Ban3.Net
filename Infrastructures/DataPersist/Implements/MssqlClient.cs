...
public class MssqlClient
{
    ...
    /// <param name="transaction"></param>
    /// <returns></returns>
    public bool UpdateByCondition(string condition, string value, DbConnection connection, DbTransaction transaction)
    {
        try
        {
        ...
        DbTransaction transaction)
    {
        ...
        if (getScopeIdentity)
        {
            foreach (PropertyInfo t in pis)
            {
                foreach (FieldSettingsAttribute attribute in
                         t.GetCustomAttributes(typeof(FieldSettingsAttribute), true))
                {
    ...
    /// <param name="transaction">事务</param>
    /// <returns></returns>
    public List<T> Find(string orderField, bool isDescending, int pageSize, int pageNo, DbConnection connection,
        DbTransaction transaction)
    {
    ...
    /// <param name="transaction">事务</param>
    /// <returns></returns>
    public Entities.Ext.StructSet<T> GetStructSet(
        string condition,
        IDbDataParameter[] paramList,
        string orderField,
        bool isDescending,
        ...
        DbTransaction transaction)
    {
        ...
        if (ds != null)
        {
            var ss = new Entities.Ext.StructSet<T>();
    ...
    /// <param name="transaction">The transaction.</param>
    /// <returns></returns>
    public List<T> GetList(string sql, CommandType commandType, IDbDataParameter[] paramList, DbConnection connection,
        DbTransaction transaction)
    {
    ...
    /// <param name="transaction">事务</param>
    /// <returns></returns>
    public object ExecuteScalar(string sql, CommandType commandType, IDbDataParameter[] paramList,
    ...
    /// <param name="transaction">事务</param>
    /// <returns></returns>
    public bool Execute(string sql, CommandType commandType, IDbDataParameter[] paramList, DbConnection connection,
        DbTransaction transaction)
    {
        DateTime start = DateTime.Now;
        bool result = true;
