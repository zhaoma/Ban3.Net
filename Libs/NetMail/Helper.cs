...
public static class Helper
{
    ...
    public static bool Send(this Entries.TargetServer server, List<string>? to, List<string>? cc, string subject,
        string mailHtml)
    {
    ...
    /// <returns></returns>
    public static void SendByMailKit(this Entries.TargetServer server, List<string>? to, List<string>? cc,
        string subject, string mailHtml)
    {
