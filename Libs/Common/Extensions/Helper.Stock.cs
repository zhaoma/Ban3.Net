...
using System.Linq;
using Ban3.Infrastructures.Common.Contracts.Enums;
using Ban3.Infrastructures.Common.Indicators.Entries;
using Ban3.Infrastructures.Common.Indicators.Inputs;
using Ban3.Infrastructures.Common.Indicators.Outputs;
...
namespace Ban3.Infrastructures.Common.Extensions
{
	...
	public static partial class Helper
	{
            ...
            StockInfo stockInfo = null)
        {
            ...
            {
                _logger.Error($"endpoint={endPoint.ObjToJson()},pt={pt},val={val},info={stockInfo.ObjToJson()}");
                _logger.Error(ex);
                return null;
            }
        }
