...
namespace Ban3.Infrastructures.Consoles.Entries
{
    ...
    public class ConsoleTable
    {
        ...
        {
            // 创建顶部和底部分隔线
            string top_DownDividerdivider = FinalColumnWides.GetTopAndDown(FormatInfo.AngleStr, ColumnBlankNum);
            // 创建分隔线
        ...
        public string GetEnd()
        {
            ...
            if (FormatInfo.IsShowTop_Down_DataBorder) down.AppendLine(FinalColumnWides.GetTopAndDown(FormatInfo.AngleStr, ColumnBlankNum));
