...
namespace Ban3.Protocols.Rfc2445.Interfaces
{
    ...
    public static class IdWithHints
    {
        ...
        /// <param name="id"></param>
        /// <param name="versionHint"></param>
        /// <param name="wasDeletedHint"></param>
        /// <returns></returns>
        public static IIdWithHints<TEntityId, TVersion> Create<TEntityId, TVersion>(
                TEntityId id,
                TVersion versionHint,
                bool? wasDeletedHint ) where TVersion : class
        {
        ...
        public static IIdWithHints<TEntityId, TVersion> Create<TEntityId, TVersion>(
                TEntityId id,
                TVersion? versionHint,
                bool? wasDeletedHint ) where TVersion : struct
        {
