...
namespace Ban3.Protocols.Rfc2445.Interfaces
{
    ...
    /// Specifying the hints can prevent the synchronizer from calling IReadOnlyEntityRepository{TEntity,TEntityId,TEntityVersion}.GetVersions(System.Collections.Generic.IEnumerable{IdWithAwarenessLevel{TEntityId}})"/>
